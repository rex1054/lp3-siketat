...
if($query->num_rows == 0) {
    ...
    <?php if(mysqli_num_rows($query)>0) { ?>
        ...
        while ($data = mysqli_fetch_array($query)) {
            $sql2 = "SELECT COUNT(penyusun.id) FROM penyusun
            JOIN dokumen ON penyusun.id_dokumen = dokumen.id
            WHERE dokumen.ta = ".$_GET['ta']." AND id_dosen = ".$data['id'];
            ...
            <td class="text-center"><?php echo $dokumen["COUNT(penyusun.id)"];?></td>
            </tr>
            <?php }
        }
        ?>
