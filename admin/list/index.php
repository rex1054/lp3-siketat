...
<option selected value="">Pilih Fakultas Terlebih Dahulu</option>
</select>
<!-- end filter prodi -->
...
if($query->num_rows == 0) {
	...
	<br/><h2>Total Tanda Terima Keseluruhan : <?php echo $query->num_rows; ?></h2><br/>
	...
	<?php if(mysqli_num_rows($query)>0) { ?>
		...
		while ($data = mysqli_fetch_array($query)) {
			...
			<a target="_blank" class="aksi" href="<?php echo $siteurl; ?>admin/preview/?id=<?php echo $data['id']; ?>&mk=<?php echo $data['mk']; ?>&author=<?php echo $penyusun['nama']; ?>"><img src="<?php echo $siteurl; ?>assets/img/show.png"></a>
			</div>
			<div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
			<a target="_self" class="aksi" href="<?php echo $siteurl; ?>admin/edit/?act=dokumen&id=<?php echo $data['id']; ?>"><img src="<?php echo $siteurl; ?>assets/img/edit.png"></a>
			</div>
			<div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
			<a target="_self" class="aksi" href="#" onclick="delet(<?php echo $data['id']; ?>)"><img src="<?php echo $siteurl; ?>assets/img/delete.png"></a>
			</div>
			</div>
			</div>
			</td>
