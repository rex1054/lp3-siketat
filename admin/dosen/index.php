...
if($query->num_rows == 0) {
	...
	<?php if(mysqli_num_rows($query)>0) { ?>
		...
		while ($data = mysqli_fetch_array($query)) {
			...
			<a target="_self" class="aksi" href="<?php echo $siteurl; ?>admin/dosen/detail/?id=<?php echo $data['id']; ?>"><img src="<?php echo $siteurl; ?>assets/img/show.png"></a>
			</div>
			<div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
			<a target="_self" class="aksi" href="<?php echo $siteurl; ?>admin/edit/?act=dosen&id=<?php echo $data['id']; ?>"><img src="<?php echo $siteurl; ?>assets/img/edit.png"></a>
			</div>
			</div>
			</div>
			</td>
					...
					for (i = 1; i < (rows.length - 1); i++) {
						//start by saying there should be no switching:
							...
							if (n == 0) {
								...
								<a href="<?php echo $siteurl; ?>admin/add-dosen/" class="btn btn-outline-success" target="_SELF">Tambah Dosen</a>
								<?php
							}
							?>