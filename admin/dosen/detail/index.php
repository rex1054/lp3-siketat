...
if($tableQuery->num_rows != 0) {
    while($table = mysqli_fetch_array($tableQuery)){
        ...
        <div id="aksi" class="container">
			...
			<a target="_self" class="aksi" href="<?php echo $siteurl; ?>admin/preview/?id=<?php echo $table['id']; ?>&mk=<?php echo $table['mk']; ?>&author=<?php echo $data['nama']; ?>"><img src="<?php echo $siteurl; ?>assets/img/show.png"></a>
			</div>
			<div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
			<a target="_self" class="aksi" href="<?php echo $siteurl; ?>admin/edit/?act=dokumen&id=<?php echo $table['id']; ?>"><img src="<?php echo $siteurl; ?>assets/img/edit.png"></a>
			</div>
			<div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
